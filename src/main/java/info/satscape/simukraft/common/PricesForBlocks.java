...
public class PricesForBlocks implements Serializable
{
    ...
    public static Float getPrice(int blockId, boolean isBuying)
    {
        ...
        if (Block.getBlockById(blockId) == Blocks.planks)
        {
            base = basePricePlanks;
        }
        else if (Block.getBlockById(blockId) == Blocks.log)
        {
            base = basePriceLogs;
        }
        else if (Block.getBlockById(blockId) == Blocks.cobblestone)
        {
            base = basePriceCobblestone;
        }
        else if (Block.getBlockById(blockId) == Blocks.stone)
        {
            base = basePriceStone;
        }
        else if (Block.getBlockById(blockId) == Blocks.glass)
        {
            base = basePriceGlass;
        }
        else if (Block.getBlockById(blockId) == Blocks.wool)
        {
            base = basePriceWool;
        }
        else if (Block.getBlockById(blockId) == Blocks.brick_block)
        {
            base = basePriceBrick;
        }
        else if (Block.getBlockById(blockId) == Blocks.stonebrick)
        {
            base = basePriceStonebrick;
        }
        else if (Block.getBlockById(blockId) == Blocks.fence)
        {
            base = basePriceFence;
        }
