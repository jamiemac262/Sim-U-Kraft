...
public class JobSoldier extends Job implements Serializable
{
    ...
    private void stageOnPatrol()
    {
        ...
        else
        {
            ...
            while (jobWorld.getBlockId(wanderTo.x.intValue(), wanderTo.y.intValue(), wanderTo.z.intValue()) > 0
                    && wanderTo.y < 255)
            {
                wanderTo.y++;
            }
        ...
        try
        {
            ...
            if (badGuy != null)
            {
                ...
                count = 100;
                theFolk.statusText = "Going to attack a " + badGuy.getEntityName();
    ...
    private void stageAttacking()
    {
        try
        {
            ...
            if (badGuy.isDead)
            {
                ...
                theFolk.statusText = "Killed " + badGuy.getEntityName();
                theFolk.isWorking = false;
            }
        }
        catch (Exception e)
