...
public class JobShepherd extends Job implements Serializable
{
    ...
    private void stageShearing()
    {
        ...
        else if (step == 3)
        {
            ...
            if (theFolk.theEntity != null)
            {
                ...
                mc.theWorld.playSound(theFolk.theEntity.posX, theFolk.theEntity.posY, theFolk.theEntity.posZ, "satscapesimukraft:shears", 1f, 1f, false);
    ...
    {
        ModSimukraft.states.credits -= (0.02f * amount);
        farmChests = inventoriesFindClosest(theFolk.employedAt, 4);
        inventoriesPut(farmChests, new ItemStack(Block.cloth, amount, metaColor), true);
        return true;
    }
