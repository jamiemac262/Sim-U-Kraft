...
public class JobCropFarmer extends Job implements Serializable
{
    ...
    private transient Block id = Blocks.air;
    ...
    //*** sets the xxx,yyy and zzz for the next farming block @return true if we're done
                ...
                while (!hasHarvest)
                {
                    ...
                    if (canHarvest)
                    {
                        if (farmingBlock.farmType == FarmType.SUGAR || farmingBlock.farmType == FarmType.CACTUS)
                        {
                            ...
                            jobWorld.setBlock(xxx, yyy + 1, zzz, Blocks.air, 0, 0x03);
                            jobWorld.setBlock(xxx, yyy + 2, zzz, Blocks.air, 0, 0x03);

                            if (farmingBlock.farmType == FarmType.SUGAR)
                            {
                                jobWorld.playAuxSFX(2001, xxx, yyy + 1, zzz, Block.getIdFromBlock(Blocks.reeds));
                                inventoriesPut(farmingChests, new ItemStack(Items.reeds, 2), false);
                            }
                            else if (farmingBlock.farmType == FarmType.CACTUS)
                            {
                                jobWorld.playAuxSFX(2001, xxx, yyy + 1, zzz, Block.getIdFromBlock(Blocks.cactus));
                        ...
                        else if (farmingBlock.farmType != FarmType.CUSTOM)
                        {
                            ...
                            jobWorld.setBlock(xxx, yyy, zzz, Blocks.air, 0, 0x03);
                        }
                        else      // CUSTOM FARM ONLY
                        {
                            ...
                            {
                            	jobWorld.setBlockToAir(xxx, yyy, zzz);
                        ...
                        {
                            //TODO: jobWorld.playAuxSFX(2001, xxx, yyy, zzz, id + (meta << 12));
                        }
                ...
                if (farmingBlock.farmType == FarmType.SUGAR)
                {
                    ...
                    if (rowCounter % 3 == 0 || (rowCounter + 1) % 3 == 0)
                    {
                        if (id != Blocks.dirt && id != Blocks.grass)
                        {
                            ...
                            jobWorld.playSound((double)xxx, (double)yyy - 1, (double)zzz,
                                               "grass", 1.0f,
                                               1.0f, false);
                            hasTilled = true;
                    ...
                    if (id == Blocks.grass || id == Blocks.dirt)
                    {
                                ...
                                || farmingBlock.farmType == FarmType.CUSTOM)
                        {
                            ...
                            jobWorld.playSound(xxx, yyy - 1, zzz,
                                               Blocks.grass.stepSound.soundName, 1.0f,
                                               1.0f, false);
                            hasTilled = true;
                            ModSimukraft.states.credits -= 0.01f;
                        }
            ...
            while (!hasSown && !done)
            {
                        ...
                        && aid == Blocks.air)
                {
                    ...
                    if (farmingBlock.farmType == FarmType.WHEAT)
                    {
                        if (ModSimukraft.gameMode != GameMode.CREATIVE)
                        {
                            ItemStack seed = inventoriesGet(farmingChests,
                                                            new ItemStack(Items.wheat_seeds, 1), false,false,-1);
                    ...
                    else if (farmingBlock.farmType == FarmType.CARROT)
                    {
                        ...
                        {
                            ItemStack seed = inventoriesGet(farmingChests,
                                                            new ItemStack(Items.carrot, 1), false,false,-1);
                    ...
                    else if (farmingBlock.farmType == FarmType.POTATO)
                    {
                        ...
                        {
                            ItemStack seed = inventoriesGet(farmingChests,
                                                            new ItemStack(Items.potato, 1), false,false,-1);
                    ...
                    else if (farmingBlock.farmType == FarmType.SUGAR)
                    {
                        ...
                        if (cid == Blocks.dirt || cid == Blocks.grass || cid == Blocks.sand)
                        {
                            ...
                            {
                                ItemStack seed = inventoriesGet(farmingChests,
                                                                new ItemStack(Items.reeds, 1), false,false,-1);
                    ...
                    else if (farmingBlock.farmType == FarmType.CACTUS)
                    {
                        if ((xxx + zzz) % 2 == 0)
                        {
                            ...
                            {
                                ItemStack seed = inventoriesGet(farmingChests,
                                                                new ItemStack(Blocks.cactus, 1), false,false,-1);
