		...
		private void stageMakeFood() {
			...
			if (step==1) {
				...
				if (isMakeFood.getItemDamage()==3) { //cheeseburger
					...
					inventoriesGet(chestsIn, new ItemStack(Items.bread,1), false, false,-1); //bread
					inventoriesGet(chestsIn, new ItemStack(Items.beef,1), false,false,-1); //raw beef
					tryMeta=1;
					...
					inventoriesGet(chestsIn, new ItemStack(Items.potato,1), false, false,-1); //potatoes
					tryMeta=3;
				}
