...
import info.satscape.simukraft.client.Gui.GuiWindmill;
	...
	public BlockWindmill(int par1, boolean par2) {
	 ...
	 @Override
	    ...
	    public void registerBlockIcons(IIconRegister iconRegister) {
	    	icons=new IIcon[1];
	    	icons[0] = iconRegister.registerIcon("satscapesimukraft:blockWindmill");
	    }
		...
		public void onBlockPlacedBy(World world, int x, int y,
	    	...
	    	if (!world.isRemote) {
		    	...
		    	if (yaw>=360) { yaw-=360; }
		    	ModSimukraft.log.info("BlockWindmill placed yaw="+yaw);
		...
		public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
	    {
	    	...
	    	if (te !=null && te.getStackInSlot(0) !=null) {
        		...
        		ModSimukraft.log.info("Windmill breakBlock dropped items");
        	}
	    ...
	    public void onBlockDestroyedByPlayer(World world, int x, int y, int z, int meta) {
	    	...
	    	world.playSoundEffect(x,y,z,"satscapesimukraft:powerdown",1f,1f);
