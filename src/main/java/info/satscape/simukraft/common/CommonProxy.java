...
public class CommonProxy
{
    ...
    public Object loadObject(String filename)//TODO: REMOVE THIS STUFF - old .suk file loader, now using .sk2
    {
        ...
        {
            ModSimukraft.log.info("OLD LOADER - Could not load object " + e.getMessage());
        }
    ...
    public static class Commodity
    {
        ...
        public static void refreshAvailableCommoditities()
        {
            ...
            for (int it = 0; it < count; it++)
            {
                ...
                {
                    Commodity cshit = ModSimukraft.theCommodities.get(shit);
                ...
                if (!gotIt)
                {
                    ModSimukraft.theCommodities.add(new Commodity(availableItems.get(index), qty, price));
                }
            }
        }
