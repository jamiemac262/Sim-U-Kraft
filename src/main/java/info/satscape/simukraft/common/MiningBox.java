         	...
         	for (File f : mineFiles.listFiles())
 	        {
 	            if (f.getName().endsWith(".sk2"))
 	            {
                     ...
                     if (theWorld !=null) {
 	                    ...
 	                    if (id == Block.getBlockById(ModSimukraft.miningBlockId))     //mining box is found at primaryXYZ
 	                    {
                ...
                if (mining != null)
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            if (id == Block.getBlockById(ModSimukraft.miningBlockId) && mining != null)    //mining box is found at primaryXYZ
                            {
