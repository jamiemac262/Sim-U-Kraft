...
public class Relationship implements Serializable
{
    ...
    public static void addRelationship(Relationship rel)
    {
        ...
        for (Relationship relation : ModSimukraft.theRelationships)
        {
        	try {
    	...
    	if (side==Side.SERVER) { 
	    	...
	    	for (int b = 0; b < ModSimukraft.theRelationships.size(); b++)
	        {
	            try {
		            ...
		            ModSimukraft.saveSK2(ModSimukraft.getSavesDataFolder() + "Relationships" + File.separator
	                                              + fn + ".sk2", strings);
    ...
    public static ArrayList<Relationship> getRelationshipsFor(FolkData theFolk)
    {
        ...
        {
           try {
        	Relationship rel = ModSimukraft.theRelationships.get(i);
