...
public class ClientTickHandler
{
   ...
   public void onTickInGame()
    {
    	System.out.println("OnTickInGame() HAS BEEN CALLED!");
...
/*TODO: Re-implement this code*/
    ...
    {
    	System.out.println("BeamingPlayer() HAS BEEN CALLED!");
        Minecraft mc = Minecraft.getMinecraft();
    ...
    {
    	System.out.println("Client Tick Handler created");
    }

    
    public void onTickStart()
    {
    	//System.out.println("onTickStart() HAS BEEN CALLED!");
    }
@SubscribeEvent
    public void onClientTick(ClientTickEvent event){
    	//System.out.println("onClientTick() HAS BEEN CALLED!");
    ...
    {
    	//System.out.println("onTickEnd() HAS BEEN CALLED!");
    	onGui();
    }
