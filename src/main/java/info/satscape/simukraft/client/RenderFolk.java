...
public class RenderFolk extends RenderBiped
{
                         ...
                         double par6, float par8, float par9)
    {
        ...
        doRender((EntityLiving) par1Entity, par2, par4, par6, par8, par9);
        
    }

    @Override
    public void doRender(EntityLiving entityliving, double d, double d1,
                               double d2, float f, float f1)
    {
        double d3 = d1 - (double) entityliving.yOffset;
        super.doRender(entityliving, d, d3, d2, f, f1);
