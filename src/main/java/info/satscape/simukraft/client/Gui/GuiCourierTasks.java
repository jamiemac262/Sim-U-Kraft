...
public class GuiCourierTasks extends GuiScreen
{
    ...
    private void initscreen()
    {
        ...
        if (onPage.contentEquals("main"))
        {
            ...
            {
                CourierTask ct = ModSimukraft.theCourierTasks.get(t);
    ...
    public void actionPerformed(GuiButton guibutton)
    {
        ...
        else if (onPage.contentEquals("add"))
        {
            ...
            else if (newtask.dropoff !=null && newtask.dropoff.name.contentEquals("")) 
            {
                ...
                newtask.name = "Task " + (ModSimukraft.theCourierTasks.size() + 1) + ""; //name of task not used really
                ModSimukraft.theCourierTasks.add(newtask);
                onPage = "main";
                initscreen();
            }
        }
