    ...
    public class ThreadFacsimile extends Thread
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                for (int l = 0; l < 200; l++)
                {
                    ...
                    for (int ftb = 0; ftb < ftbCount; ftb++)
                    {
                        for (int ltr = 1; ltr <= ltrCount; ltr++)
                        {
                            ...
                            int yyy = (by + l) - 1;
                            int zzz = bz + zo;
                            iD = mc.getIntegratedServer().worldServerForDimension(thePlayer.dimension).getBlock(xxx, yyy, zzz);
                ...
                mc.theWorld.playSoundEffect(location.x, location.y, location.z, "satscapesimukraft:computer", 1f, 1f);
