...
public class GuiControlBox extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if (theBuilding.type.contentEquals("commercial") || theBuilding.type.contentEquals("industrial"))
        {
            int down = 70;
            ...
            for (int fc = 0; fc < ModSimukraft.theFolks.size(); fc++)
            {
                FolkData folk = (FolkData) ModSimukraft.theFolks.get(fc);
        ...
        if (theBuilding.type.contentEquals("industrial"))
        {
            ...
            if (theBuilding.displayName.contains("Builders Merchant"))
            {
                ...
                if (!ModSimukraft.isDayTime() || employeeCount == 0)
                {
                    b2.enabled = false;
                }
    ...
    public void drawScreen(int i, int j, float f)
    {
        try
        {
            ...
            if (theBuilding != null)
            {
                ...
                else if (theBuilding.type.contentEquals("industrial") || theBuilding.type.contentEquals("commercial"))
                {
    ...
    public void actionPerformed(GuiButton guibutton)
    {
        ...
        else if (guibutton.displayString.contentEquals("Fix House"))
        {
            ...
            Building b;
            b = new Building("Repaired House", "residential", location, location, true);
            ModSimukraft.theBuildings.add(b);
        ...
        else if (guibutton.id == 30)   //Beam me to...
        {
        	...
        	/*TODO: re-implement the following method*/
        	//rotateStairs();
        }
        else if (guibutton.displayString.contentEquals("Demolish!"))
        {
            ...
            {
                Building build = ModSimukraft.theBuildings.get(i);
            ...
            for (V3 blockLoc : theBuilding.blockLocations)
            {
                ...
                if (l != Blocks.air && ModSimukraft.demolishBlocks.size() < 500)
                {
                    
                    ModSimukraft.demolishBlocks.add(blockLoc);
                }

                theWorld.setBlock(blockLoc.x.intValue(), blockLoc.y.intValue(), blockLoc.z.intValue(), l, 0, 0x03);
    ...
    /*private void rotateStairs()
    {
        ...
        theWorld.playSoundEffect(theBuilding.primaryXYZ.x,theBuilding.primaryXYZ.y,theBuilding.primaryXYZ.z, "satscapesimukraft:computer", 1f, 2f);
        ...
        for (V3 blockLoc : theBuilding.blockLocations)
        {
            ...
            if (BlockStairs.isBlockStairs(is.getItem())
            ...
            else if (is.getItem()==Block.torchWood.blockID || is.getItem()==Block.torchRedstoneActive.blockID || is.getItem()==Block.torchRedstoneIdle.blockID) {
            ...
            // beds
            } else if(is.getItem()==Block.bed.blockID) {
            	int newmeta = is.getItemDamage();
            	newmeta++;
            ...
            //pistons	
            } else if(is.getItem()==Block.pistonBase.blockID || is.getItem()==Block.pistonExtension.blockID
            	|| is.getItem()==Block.pistonStickyBase.blockID) {
            	int newmeta = is.getItemDamage();
            ...
            } else if(is.getItem()==Block.signPost.blockID) {
            	int newmeta = is.getItemDamage();
            ...
            } else if(is.getItem()==Block.signWall.blockID || is.getItem()==Block.ladder.blockID) {
            	int newmeta = is.getItemDamage();
            	if (newmeta==2) {newmeta=5;}
            	else if(newmeta==5) {newmeta=3;}
            	else if(newmeta==3) {newmeta=4;}
            ...
            //buttons
            } else if(is.getItem()==Block.stoneButton.blockID || is.getItem()==Block.woodenButton.blockID) {
            	int newmeta = is.getItemDamage();
            ...
            // fence gates
            } else if(is.getItem()==Block.fenceGate.blockID) {
            	int newmeta = is.getItemDamage();
            	newmeta++;
